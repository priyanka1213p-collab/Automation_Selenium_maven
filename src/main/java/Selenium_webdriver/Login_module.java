...
//		System.out.println("Error Message:" +error.getText());
        ...
        driver.findElement(By.id("email")).sendKeys("priyankaa1213.p@gmail.com");
        driver.findElement(By.id("passwd")).sendKeys("priyanka@123");
        Thread.sleep(2000);

        driver.findElement(By.id("SubmitLogin")).click();
        Thread.sleep(2000);
		String msg = driver.findElement(By.className("error-copy")).getText();
